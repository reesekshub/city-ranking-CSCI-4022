...
OUTPUT_DIR = os.path.join("data", "bike_over_drive")


def compute_bike_over_drive() -> None:
    """
    ...
    for city in cities:
        ...
        with open(out_path, "w", newline="", encoding="utf-8") as f:
            ...
            for label, bike_row, drive_row in zip(row_labels, bike_vals, drive_vals):
                delta_row = [
                    b / d if (b is not None and d is not None and d != 0) else ""
